...
return Configuration::VERSION_2 + [
    ...
    'guards' => [
        ...
        'web' => [
            ...
            'management_audience' => env('AUTH0_API_AUDIENCE'),
        ],
    ],

    'routes' => [
        Configuration::CONFIG_ROUTE_INDEX => Configuration::get(Configuration::CONFIG_ROUTE_INDEX, '/'),
        Configuration::CONFIG_ROUTE_CALLBACK => Configuration::get(Configuration::CONFIG_ROUTE_CALLBACK, '/auth0/callback'),
        Configuration::CONFIG_ROUTE_LOGIN => Configuration::get(Configuration::CONFIG_ROUTE_LOGIN, '/login'),
        Configuration::CONFIG_ROUTE_AFTER_LOGIN => Configuration::get(Configuration::CONFIG_ROUTE_AFTER_LOGIN, '/countries'),
